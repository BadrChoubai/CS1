...
def get_tip_amount() -> float:
	...
	(3) 20% Tip
	""")
	tip_amount_selection = input("Tip Selection: ")

	def tip_amount(tip_amount_selection: int) -> float:
	...
	return tip_amount(tip_amount_selection)
...
def main():
	...
	bill_total = calculate_bill_total(bill_amount, TAX_PERCENTAGE, tip_percentage)

...
def main():
    prompts: list = ["What is your first name?", "What is your middle name?", "What is your last name?"]

    [first_name, middle_name, last_name] = get_user_input(prompts)
   
    print(f"{ last_name.title() }, { first_name.title() } { middle_name or  '' }")
    print(f"{ first_name[0].upper() }{ middle_name[0].upper() if middle_name else '' }{ last_name[0].upper() }") 
